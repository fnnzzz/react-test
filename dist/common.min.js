...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_reactRouter.Router, { history: _reactRouter.browserHistory, routes: _routes2.default }), document.getElementById('react_app'));
	  ...
	  childRoutes: [(_ref = {
	    ...
	    getComponent: function getComponent(location, callback) {
	      __webpack_require__.e/* nsure */(1, function (require) {
	        callback(null, __webpack_require__(233).default);
	      });
	    }
	  }, _defineProperty(_ref, 'path', "about"), _defineProperty(_ref, 'getComponent', function getComponent(location, callback) {
