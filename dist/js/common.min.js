...
/***/ function(module, exports, __webpack_require__) {
	...
	var myCss = __webpack_require__(166);
	...
	var ItemShow = React.createClass({
		...
		orderItem: function orderItem() {
			...
			ReactDOM.render(React.createElement(ItemInfo, { infoText: this.props.item.infoText, title: this.props.item.title }), document.getElementById('info_about_item'));
		...
		render: function render() {
			...
			return React.createElement(
				'tr',
				{ id: 'itemClass', className: this.state.disableClass },
				React.createElement(
					'td',
					null,
				...
				React.createElement(
					...
					React.createElement('span', { id: 'buy_icon', 'data-remodal-target': 'item_info', onClick: this.orderItem, style: iconCursorStyle, className: 'glyphicon glyphicon-shopping-cart' })
				)
			);
		}
	...
	var ItemsList = React.createClass({
		...
		render: function render() {
			...
			var itemsList = this.props.items.map(function (item, index) {
				...
				return React.createElement(ItemShow, { key: item.index, item: item });
			});
	...
	ReactDOM.render(React.createElement(ItemsList, { items: defaultItems }), document.getElementById('items_table'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".plus_sign{\n\tcursor: pointer;\n\tfont-size: 4rem;\n\tpadding-left: 1rem; \n}\n\n.table_info {\n\twidth: 20px;\n\theight: 20px;\n\tvertical-align: middle;\n\tcursor: pointer;\n}\n\n.add_item_wrap .form-group { \n\ttext-align: left;\n}\n\n.remodal-cancel {\n\tmargin-left: 2rem !important\n}\n\ntr.disabled {\n\tcolor: #999;\n}\n\ntr.disabled #buy_icon {\n\tdisplay: none;\n}\n\n\n#info_about_item h3 {\n\ttext-align: left;\n}\n\n#info_about_item p {\n\ttext-align: left;\n}\n\n#itemClass #buy {\n\ttext-align: center;\n}", ""]);
